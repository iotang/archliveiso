...
make_customize_airootfs() {
    ...
    curl -o ${work_dir}/x86_64/airootfs/etc/pacman.d/mirrorlist.backup 'https://www.archlinux.org/mirrorlist/?country=all&protocol=http&use_mirror_status=on'
...
make_efi() {
    ...
    cp ${work_dir}/../Shell.efi ${work_dir}/iso/EFI/shellx64_v2.efi
    ...
    cp ${work_dir}/../Shell_Full.efi ${work_dir}/iso/EFI/shellx64_v1.efi
}
